...
- [D-Code](https://dcode-network.eu/){:target="_blank"}, fundamentals of Design Competence for our Digital Future [H2020 ITN 2021+]
- [IoT Rapid Proto Lab](https://www.rapidprotolabs.eu/){:target="_blank"}, Erasmus+ project to explore the interdisciplinary teaching of IoT [2018-2021].
- [Building rhythm](https://www.tudelft.nl/en/covid/wellbeing#c658811){:target="_blank"} [2020-2021]
- [Bucket](https://dwd.tudelft.nl/bucket){:target="_blank"}, a data platform for designers which facilitates Data-Driven Design prototyping.
- [Responsible Internet of Things (IoT) Data Research](https://www.delftdesignforvalues.nl/projects/responsible-iot-data-research/){:target="_blank"} [Funded by the Delft Design for Values Institute, 2019-2020]
...
- 2019-2020 Design/Coordination – `MSc Elective` Prototyping Connected Products ([ID5415](https://studiegids.tudelft.nl/a101_displayCourse.do?course_id=56000){:target="_blank"})
- 2018-2021 Lecture - `MSc` Smart System Technologies ([ID4175 AED SST](https://studiegids.tudelft.nl/a101_displayCourse.do?course_id=55919){:target="_blank"})
- 2019 Design/Coordination - Data-Driven Design Approach (2-week intervention as part of `BSc Elective` Designing for sustainability Transition)
- 2018 Coordination - `MSc Elective` Developing Data-Driven Products ([ID5452B](https://studiegids.tudelft.nl/a101_displayCourse.do?course_id=47470){:target="_blank"})
- 2018 Lecture - `MSc Elective` Designing Data-Driven Products ([ID5452A](https://studiegids.tudelft.nl/a101_displayCourse.do?course_id=47371){:target="_blank"})
...
- FXPal
- Lab talk RtD
- [PowerWeb - Life after your PhD in a Scientific World](https://www.tudelft.nl/powerweb/newsevents/phd-poster-contest-2018-kick-off-powerweb-institute){:target="_blank"}

### Other Activities

- Current - [Honours Programme Master](https://www.tudelft.nl/en/io/studeren/masteropleidingen/specialisations-and-annotations/honours-programme-master-ide){:target="_blank"} - Coordinator for students from the IPD Master
- Current - [Data Champion](https://www.tudelft.nl/library/research-data-management/r/support/data-champions/onze-data-champions/faculty-of-industrial-design-engineering){:target="_blank"}
- Current - [PowerWeb Executive Committee](https://www.tudelft.nl/powerweb/about/people/executive-committee){:target="_blank"}
